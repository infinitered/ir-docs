...
The `run` property should be a function (async or not) that does whatever you want it to. You'll receive the gluegun `toolbox` object which contains the [core extensions](Toolbox/toolbox-api.md) and any additional extensions you've loaded.
...
If you'd like to follow a tutorial to make a plugin, check out the ["Making a Plugin" tutorial](../gluegun-new/Tutorials/tutorial-making-a-plugin.md).
